...
export function ScheduledTasksModal({
  ...
  const getStatusBadge = (status: TaskStatus, isEnabled: boolean) => {
    ...
    switch (status) {
      case 'running':
        return (
          <span className="px-2 py-0.5 rounded-full text-[10px] font-medium bg-blue-500/20 text-blue-300 border border-blue-500/30 flex items-center gap-1 animate-pulse">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-3xl max-h-[85vh] bg-[#14171f] border border-[#232834] rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-150 select-none">
        {/* Cabecera del Modal */}
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#1e232e] bg-[#111317]">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold shadow-md shadow-blue-600/20 transition-all active:scale-[0.98]"
            >
        ...
        {isCreating && (
          <form
            ...
            className="p-4 bg-[#181c25] border-b border-[#232834] flex flex-col gap-3 animate-in slide-in-from-top-2 duration-150"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 rounded-xl bg-[#111317] border border-slate-700 text-slate-200 text-xs focus:outline-none focus:border-blue-500"
                />
              </div>
            ...
            {schedulePreset === 'custom' && (
              <div>
                ...
                <input
                  ...
                  placeholder="0 9 * * *"
                  className="w-full px-3 py-1.5 rounded-xl bg-[#111317] border border-slate-700 text-slate-200 text-xs font-mono focus:outline-none focus:border-blue-500"
                />
              </div>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 rounded-xl bg-[#111317] border border-slate-700 text-slate-200 text-xs focus:outline-none focus:border-blue-500 font-mono"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 rounded-xl bg-[#111317] border border-slate-700 text-slate-200 text-xs focus:outline-none focus:border-blue-500 resize-none font-sans"
              />
            </div>
            ...
            <div className="flex items-center justify-end gap-2 pt-1">
              ...
              <button
                type="submit"
                className="px-4 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs shadow-md"
              >
                Guardar tarea
              </button>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-3">
          {isLoading ? (
            ...
            <div className="py-12 flex flex-col items-center justify-center text-center p-6 text-slate-400 gap-3">
              <div className="w-12 h-12 rounded-2xl bg-surface-elevated flex items-center justify-center text-slate-500">
              ...
              return (
                <div
                  ...
                  className={`p-3.5 rounded-xl border transition-all flex flex-col gap-2.5 ${
                    task.isEnabled
                      ? 'bg-[#181c25] border-[#262c38] hover:border-slate-600'
                      : 'bg-[#14161d]/60 border-[#1e222b] opacity-65'
                  }`}
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-start gap-2.5 min-w-0 flex-1">
                      <div className="w-8 h-8 rounded-lg bg-blue-950/40 border border-blue-500/20 flex items-center justify-center text-blue-400 shrink-0 mt-0.5">
                        <Clock className="w-4 h-4" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <span className="px-2 py-0.2 rounded-md bg-blue-950/60 border border-blue-500/30 text-blue-300 text-[10px] font-mono">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      <button
                        ...
                        disabled={isRunning}
                        className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-emerald-600/20 hover:bg-emerald-600/30 border border-emerald-500/30 text-emerald-300 text-[11px] font-medium transition-all disabled:opacity-50"
                  ...
                  {/* Prompt de la Tarea */}
                  <div className="text-[11px] text-slate-300 bg-[#101217] p-2.5 rounded-lg border border-[#1e222b] font-sans leading-relaxed">
                  ...
                  {task.lastResult && (
                    <div className="flex flex-col gap-1 pt-1 border-t border-slate-800/80">
                      <button
                        ...
                        className="flex items-center justify-between text-[10px] text-slate-400 hover:text-slate-200"
                      >
                      ...
                      {isExpanded && (
                        <div className="p-2.5 rounded-lg bg-black/40 border border-slate-800 text-[11px] font-mono text-slate-300 max-h-48 overflow-y-auto whitespace-pre-wrap select-text">
                          {task.lastResult}
                        </div>
                      )}
                    </div>
                  ...
                  {deleteConfirmId === task.id && (
                    <div className="p-2.5 rounded-lg bg-[#241518] border border-rose-500/40 flex items-center justify-between text-xs animate-in fade-in">
